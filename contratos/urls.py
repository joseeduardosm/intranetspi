...
urlpatterns = [
    ...
    path('contratos/<int:contrato_pk>/item/<int:pk>/editar/', views.ContratoItemUpdateView.as_view(), name='item_update'),
    path('contratos/<int:contrato_pk>/item/<int:pk>/excluir/', views.ContratoItemDeleteView.as_view(), name='item_delete'),
    ...
    path('contratos/<int:contrato_pk>/checklist-modelo/novo/', views.ChecklistModeloCreateView.as_view(), name='checklist_modelo_create'),
    ...
    path('checklist/<int:item_pk>/anexo/editar/', views.ChecklistAnexoUpdateView.as_view(), name='checklist_anexo_update'),
    path('checklist/<int:item_pk>/anexo/limpar/', views.ChecklistAnexoDeleteView.as_view(), name='checklist_anexo_delete'),
    ...
    path('competencias/<int:pk>/pagamento/inserir/', views.CompetenciaPagamentoExecutarView.as_view(), name='competencia_pagamento_executar'),
