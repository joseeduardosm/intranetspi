...
urlpatterns = [
    ...
    path('avaliacoes-padrao/', views.FormularioAvaliacaoPadraoGlobalListView.as_view(), name='avaliacao_padrao_list'),
    path('avaliacoes-padrao/<int:pk>/', views.FormularioAvaliacaoPadraoGlobalDetailView.as_view(), name='avaliacao_padrao_detail'),
    ...
    path('avaliacoes-padrao/novo/', views.FormularioAvaliacaoPadraoGlobalCreateView.as_view(), name='avaliacao_padrao_create'),
    path('avaliacoes-padrao/<int:pk>/editar/', views.FormularioAvaliacaoPadraoGlobalUpdateView.as_view(), name='avaliacao_padrao_update'),
    path('avaliacoes-padrao/<int:pk>/excluir/', views.FormularioAvaliacaoPadraoGlobalDeleteView.as_view(), name='avaliacao_padrao_delete'),
    path('avaliacoes-padrao/<int:formulario_padrao_pk>/escala/nova/', views.EscalaNotaAvaliacaoPadraoGlobalCreateView.as_view(), name='avaliacao_padrao_escala_create'),
    path('avaliacoes-padrao/escala/<int:pk>/editar/', views.EscalaNotaAvaliacaoPadraoGlobalUpdateView.as_view(), name='avaliacao_padrao_escala_update'),
    path('avaliacoes-padrao/escala/<int:pk>/excluir/', views.EscalaNotaAvaliacaoPadraoGlobalDeleteView.as_view(), name='avaliacao_padrao_escala_delete'),
    path('avaliacoes-padrao/<int:formulario_padrao_pk>/faixa/nova/', views.FaixaLiberacaoAvaliacaoPadraoGlobalCreateView.as_view(), name='avaliacao_padrao_faixa_create'),
    path('avaliacoes-padrao/faixa/<int:pk>/editar/', views.FaixaLiberacaoAvaliacaoPadraoGlobalUpdateView.as_view(), name='avaliacao_padrao_faixa_update'),
    path('avaliacoes-padrao/faixa/<int:pk>/excluir/', views.FaixaLiberacaoAvaliacaoPadraoGlobalDeleteView.as_view(), name='avaliacao_padrao_faixa_delete'),
    path('avaliacoes-padrao/<int:formulario_padrao_pk>/grupo/novo/', views.GrupoAvaliacaoPadraoGlobalCreateView.as_view(), name='avaliacao_padrao_grupo_create'),
    path('avaliacoes-padrao/grupo/<int:pk>/editar/', views.GrupoAvaliacaoPadraoGlobalUpdateView.as_view(), name='avaliacao_padrao_grupo_update'),
    path('avaliacoes-padrao/grupo/<int:pk>/excluir/', views.GrupoAvaliacaoPadraoGlobalDeleteView.as_view(), name='avaliacao_padrao_grupo_delete'),
    path('avaliacoes-padrao/grupo/<int:grupo_padrao_pk>/item/novo/', views.ItemAvaliacaoPadraoGlobalCreateView.as_view(), name='avaliacao_padrao_item_create'),
    path('avaliacoes-padrao/item/<int:pk>/editar/', views.ItemAvaliacaoPadraoGlobalUpdateView.as_view(), name='avaliacao_padrao_item_update'),
    path('avaliacoes-padrao/item/<int:pk>/excluir/', views.ItemAvaliacaoPadraoGlobalDeleteView.as_view(), name='avaliacao_padrao_item_delete'),
    path('<int:contrato_pk>/avaliacoes-padrao/carregar/', views.FormularioAvaliacaoPadraoCarregarView.as_view(), name='avaliacao_padrao_carregar'),
    ...
    path('competencias/<int:pk>/reset/', views.CompetenciaResetView.as_view(), name='competencia_reset'),
