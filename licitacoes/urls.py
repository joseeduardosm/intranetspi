...
urlpatterns = [
    ...
    path('etp-tic/<int:pk>/compartilhar/', views.EtpTicShareView.as_view(), name='etp_share'),
    ...
    path('dfd/<int:pk>/compartilhar/', views.DfdShareView.as_view(), name='dfd_share'),
    ...
    path('tr/<int:termo_pk>/pesquisa-preco/fornecedores/<int:pk>/nota/', views.PesquisaPrecoFornecedorNotaCreateView.as_view(), name='pesquisa_preco_fornecedor_nota'),
    ...
    path('tr/<int:pk>/compartilhar/', views.TermoShareView.as_view(), name='tr_share'),
